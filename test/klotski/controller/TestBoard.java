...
public class TestBoard {
	...
	/* 
    @Test 
	public void  testconfrontoArray() {
	 Piece testPieceA= new Piece(0,2,2,2);
	 Piece testPieceB= new Piece(3,2,1,2);
	 Piece testPieceC= new Piece(2,2,1,1);
	 Piece testPieceD= new Piece(3,3,1,2);
	 Piece[] TestArrayA= {testPieceA,testPieceB,testPieceC};
	 Piece[] TestArrayB= {testPieceB,testPieceC,testPieceA};
	Piece[]  TestArrayC= {testPieceB,testPieceC,testPieceD};
	 Boolean temp = confrontoArray(TestArrayA,TestArrayB);
	...
	*/
	...
	Board TestBoardA = new Board();
    Board TestBoardB = new Board();
	Board TestBoardC = new Board();
	TestBoardA.setConfig(1);
	TestBoardB.setConfig(1);
	TestBoardC.setConfig(2);
	assertTrue(TestBoardA.equals(TestBoardB));
	assertTrue(TestBoardA.equals(TestBoardC));
	}
}
