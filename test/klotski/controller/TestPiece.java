...
public class TestPiece {
   ...
   public void testEquals(){
	Piece testPieceA = new Piece(1,2,3,4);
	Piece testPieceB = new Piece(1,2,3,4);
	Piece testPieceC = new Piece(1,2,3,2);
    //i due pezzi sono uguali 
	assertTrue(testPieceA.equals(testPieceB));
    //i due pezzi sono diversi 
	assertFalse(testPieceA.equals(testPieceC));
   }
}
